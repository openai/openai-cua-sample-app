...
def release_macos():
    ...
    while True:
        held = [button for button in (Quartz.kCGMouseButtonLeft, Quartz.kCGMouseButtonCenter,
...
def release_windows():
    ...
    extended = {0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28,
                0x2D, 0x2E, 0x5B, 0x5C, 0x6F, 0x90, 0xA3, 0xA5}
    release_inputs(
        range(8, 255),
