...
- [Tzafon](https://tzafon.ai) (remote browser, requires account)
...
| `Tzafon`            | tzafon             | `browser` | Remote browser environment        | [Tzafon](https://tzafon.ai/dashboard) API key in `.env`          |
