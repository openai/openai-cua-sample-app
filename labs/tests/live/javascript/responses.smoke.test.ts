...
import { RunnerManager } from "../../../../javascript-app/packages/runner-core/src/index.js";
...
beforeAll(() => {
  ...
  if (!process.env.OPENAI_API_KEY) {
    throw new Error(
      "OPENAI_API_KEY must be set to run labs/tests/live/javascript/responses.smoke.test.ts",
    );
  }
});
