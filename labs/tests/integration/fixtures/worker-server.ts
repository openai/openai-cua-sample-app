...
const { chromium } = createRequire(new URL("../../../../javascript-app/package.json", import.meta.url))("playwright") as typeof import("playwright");

import { createServer } from "../../../../javascript-app/src/server.js";
