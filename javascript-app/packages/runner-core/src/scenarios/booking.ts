...
class BookingCodeExecutor implements RunExecutor {
  async execute(context: RunExecutionContext) {
    validateVerificationPrompt(context, parseBookingRequest, "Use the structured prompt in repository-root labs/docs/scenarios.md, or turn verification off for a free-form task.");
