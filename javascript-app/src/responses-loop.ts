...
import { type JavaScriptSession } from "./browser/javascript-process.js";
...
export function createDefaultResponsesClient(): ResponsesClient {
  const apiKey = process.env.OPENAI_API_KEY?.trim();
  if (!apiKey) {
    throw new RunnerCoreError("OPENAI_API_KEY is required to run the agent.", {
