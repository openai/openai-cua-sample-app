...
const makeDetail = (): RunDetail => ({
  run: { id: "run-test", scenarioId: scenario.id, labId: scenario.labId, browserMode: "headless", model: "gpt-5.6-sol", prompt: "test", status: "running", startedAt: event.createdAt },
